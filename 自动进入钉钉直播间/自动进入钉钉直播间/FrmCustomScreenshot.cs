...
namespace 自动进入钉钉直播间
{
    public partial class FrmCustomScreenshot : Form
    {
        ...
        public FrmCustomScreenshot(bool save_to_desk, string desk_path, string ding_ding_class,string ding_ding_path)
        {
