...
![图片](https://uploader.shimo.im/f/mqymBB5T9V0VNI29!thumbnail)

![图片](https://uploader.shimo.im/f/8gzxeMfRmC2F3IEg!thumbnail)
...
2020-05-11 15:15 添加：1、在通用文字识别的基础上添加了通用文字识别（含位置信息版）、通用文字识别（高精度版）、通用文字识别（高精度含位置版）

在通用文字识别调用失败时，自动依次调用其他文字识别
